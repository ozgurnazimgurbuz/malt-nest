...
import { compareQualityMetrics } from '../optimization/compare'
 ...
 * Order: placed↓, sheets↑, utilization↓, packedBounds↑. Tie → free.
 */
...
export function compareNestQuality(a: NestResult, b: NestResult): number {
  return compareQualityMetrics(
    {
      placed: a.metrics.placedCount,
      sheets: a.metrics.sheetCount,
      utilization: a.metrics.utilization,
      packedBoundsMm2: a.metrics.packedBoundsMm2,
    },
    {
      placed: b.metrics.placedCount,
      sheets: b.metrics.sheetCount,
      utilization: b.metrics.utilization,
      packedBoundsMm2: b.metrics.packedBoundsMm2,
    },
  )
}
